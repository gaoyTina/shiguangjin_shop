...
<body>
	<form method="post" action="login">
		<div id="logincontainer">
			<h3 class="title">时光锦后台管理系统v1.0</h3>
			<div class="loginform" >
				<p id="msg">
					<strong><%=msg%></strong>
				</p>
				<p>
					<span class="lablespan">用户名:</span><span><input
						name="username" type="text" id="username" /></span>
				</p>
				<p>
					<span class="lablespan">密 码:</span><span><input
						name="password" type="password" id="password" /></span>
				</p>
				<p>
