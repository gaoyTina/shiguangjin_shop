...
<body>
	...
	<div class="linear">
		<img src="../img/logo.jpg" style="height: 100px; width: 100%" />
	</div>
	<ul class="nav">
	...
	<div class="timeanduser">
		...
		<p id="currentuser">
			当前用户: 【<%= ((Map<String,Object>)session.getAttribute("currentuser")).get("truename")%>】<a
				href="logout" target="_top" id="logout" title="退出系统"><img
				src="../img/logout5.png"></a>
		</p>
	</div>
