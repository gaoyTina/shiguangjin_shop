	...
	<div class="main">
		...
		<div class="listwrapper">
			...
			<div class="rightlist">
				...
				<div class="content">
					<form action="uiguestbookadd" method="post">
						<table border="0" cellspacing="0" cellpadding="0" class="tb">
							<tr><td class="lable">姓名</td><td><input type="text" name="username" /></td></tr>
							<tr><td class="lable">电话</td><td><input type="text" name="tel" /></td></tr>
							<tr><td class="lable">内容</td><td><textarea name="contents"></textarea> </td></tr>
							<tr><td class="lable">&nbsp;</td><td><input type="submit" value="提交留言" style="height:24px; line-height:24px; width: 120px;"> </td></tr>
						</table>
					</form>
				</div>
			</div>
